...
/**
 * A transliterator that converts all letters (as defined by <code>UCharacter.isLetter()</code>) to lower case, except for those letters
 * preceded by non-letters. The latter are converted to title case using <code>UCharacter.toTitleCase()</code>.
 * 
 * @author Alan Liu
 */
