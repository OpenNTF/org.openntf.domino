...
public enum DisplayContext {
	 ...
	 */
	/**
	 * A possible setting for DIALECT_HANDLING: use standard names when generating a locale name, e.g. en_GB displays as 'English (United
	 * Kingdom)'.
	 * 
	 * @draft ICU 51
	 * @provisional This API might change or be removed in a future release.
	...
	/**
	 * A possible setting for CAPITALIZATION: The capitalization context if a date, date symbol or display name is to be formatted with
	...
	/**
	 * A possible setting for CAPITALIZATION: The capitalization context if a date, date symbol or display name is to be formatted with
	 * capitalization appropriate for stand-alone usage such as an isolated name on a calendar page.
	 * 
	 * @draft ICU 51
	 * @provisional This API might change or be removed in a future release.
	 */
