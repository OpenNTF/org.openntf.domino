...
/**
 * <code>AnnualTimeZoneRule</code> is a class used for representing a time zone rule which takes effect annually. Years used in this class
 * are all Gregorian calendar years.
 * 
 * @stable ICU 3.8
 */
public class AnnualTimeZoneRule extends TimeZoneRule {
	...
	/**
	 * Constructs a <code>AnnualTimeZoneRule</code> with the name, the GMT offset of its standard time, the amount of daylight saving offset
	 * adjustment, the annual start time rule and the start/until years.
	 * 
	 * @param name
	 *            The time zone name.
	 * @param rawOffset
	 *            The GMT offset of its standard time in milliseconds.
	 * @param dstSavings
	 *            The amount of daylight saving offset adjustment in milliseconds. If this ia a rule for standard time, the value of this
	 *            argument is 0.
	 * @param dateTimeRule
	 *            The start date/time rule repeated annually.
	 * @param startYear
	 *            The first year when this rule takes effect.
	 * @param endYear
	 ...
	 * 
	 * @return An <code>AnnualDateTimeRule</code> which represents the start date/time rule used by this time zone rule.
	 * 
	 * @stable ICU 3.8
	 */
	 ...
	 * 
	 * @return The start year of this rule. The year is in Gregorian calendar with 0 == 1 BCE, -1 == 2 BCE, etc.
	 * 
	 * @stable ICU 3.8
	 */
	 ...
	 * 
	 * @return The end year of this rule (inclusive). The year is in Gregorian calendar with 0 == 1 BCE, -1 == 2 BCE, etc.
	 * 
	 * @stable ICU 3.8
	 */
	 ...
	 * 
	 * @param year
	 *            The Gregorian year, with 0 == 1 BCE, -1 == 2 BCE, etc.
	 * @param prevRawOffset
	 *            The standard time offset from UTC before this rule takes effect in milliseconds.
	 * @param prevDSTSavings
	 *            The amount of daylight saving offset from the standard time.
	 * 
	 * @return The time when this rule takes effect in the year, or null if this rule is not applicable in the year.
	 * 
	 * @stable ICU 3.8
	 */
	...
	public boolean isEquivalentTo(TimeZoneRule other) {
		...
		if (startYear == otherRule.startYear && endYear == otherRule.endYear && dateTimeRule.equals(otherRule.dateTimeRule)) {
	...
	/**
	 * Returns a <code>String</code> representation of this <code>AnnualTimeZoneRule</code> object. This method is used for debugging
	 * purpose only. The string representation can be changed in future version of ICU without any notice.
	 * 
	 * @stable ICU 3.8
	 */
	@Override
