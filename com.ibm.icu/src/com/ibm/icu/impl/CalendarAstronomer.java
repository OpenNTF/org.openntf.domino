...
/**
 * <code>CalendarAstronomer</code> is a class that can perform the calculations to determine the positions of the sun and moon, the time of
 * sunrise and sunset, and other astronomy-related data. The calculations it performs are in some cases quite complicated, and this utility
 * class saves you the trouble of worrying about them.
 * <p>
 * The measurement of time is a very important part of astronomy. Because astronomical bodies are constantly in motion, observations are
 * only valid at a given moment in time. Accordingly, each <code>CalendarAstronomer</code> object has a <code>time</code> property that
 * determines the date and time for which its calculations are performed. You can set and retrieve this property with {@link #setDate
 * setDate}, {@link #getDate getDate} and related methods.
 * <p>
 * Almost all of the calculations performed by this class, or by any astronomer, are approximations to various degrees of accuracy. The
 * calculations in this class are mostly modelled after those described in the book <a
 * href="http://www.amazon.com/exec/obidos/ISBN=0521356997" target="_top"> Practical Astronomy With Your Calculator</a>, by Peter J.
 * Duffett-Smith, Cambridge University Press, 1990. This is an excellent book, and if you want a greater understanding of how these
 * calculations are performed it a very good, readable starting point.
 * <p>
 * <strong>WARNING:</strong> This class is very early in its development, and it is highly likely that its API will change to some degree in
 * the future. At the moment, it basically does just enough to support {@link com.ibm.icu.util.IslamicCalendar} and
 * {@link com.ibm.icu.util.ChineseCalendar}.
 * 
 * @author Laura Werner
 * @author Alan Liu
 * @internal
...
public class CalendarAstronomer {
	...
	/**
	 * The average number of solar days from one new moon to the next. This is the time it takes for the moon to return the same ecliptic
	 * longitude as the sun. It is longer than the sidereal month because the sun's longitude increases during the year due to the
	 * revolution of the earth around the sun. Approximately 29.53.
	 * 
	 * @see #SIDEREAL_MONTH
	 * @internal
	 */
	...
	/**
	 * The average number of days it takes for the moon to return to the same ecliptic longitude relative to the stellar background. This is
	 * referred to as the sidereal month. It is shorter than the synodic month due to the revolution of the earth around the sun.
	 * Approximately 27.32.
	 * 
	 * @see #SYNODIC_MONTH
	 * @internal
	...
	/**
	 * The average number number of days between successive vernal equinoxes. Due to the precession of the earth's axis, this is not
	 * precisely the same as the sidereal year. Approximately 365.24
	 * 
	 * @see #SIDEREAL_YEAR
	 * @internal
	 */
	...
	/**
	 * The average number of days it takes for the sun to return to the same position against the fixed stellar background. This is the
	 * duration of one orbit of the earth about the sun as it would appear to an outside observer. Due to the precession of the earth's
	 * axis, this is not precisely the same as the tropical year. Approximately 365.25.
	 * 
	 * @see #TROPICAL_YEAR
	 * @internal
	 */
	...
	/**
	 * The start of the julian day numbering scheme used by astronomers, which is 1/1/4713 BC (Julian), 12:00 GMT. This is given as the
	 * number of milliseconds since 1/1/1970 AD (Gregorian), a negative number. Note that julian day numbers and the Julian calendar are
	...
	/**
	 * Construct a new <code>CalendarAstronomer</code> object that is initialized to the specified time. The time is expressed as a number
	 * of milliseconds since January 1, 1970 AD (Gregorian).
	 * 
	...
	/**
	 * Construct a new <code>CalendarAstronomer</code> object with the given latitude and longitude. The object's time is set to the current
	 * date and time.
	 * <p>
	 * 
	 * @param longitude
	 *            The desired longitude, in <em>degrees</em> east of the Greenwich meridian.
	 * 
	 * @param latitude
	 *            The desired latitude, in <em>degrees</em>. Positive values signify North, negative South.
	 * 
	 * @see java.util.Date#getTime()
	 * @internal
	 */
	...
	/**
	 * Set the current date and time of this <code>CalendarAstronomer</code> object. All astronomical calculations are performed based on
	 * this time setting.
	 * 
	 * @param aTime
	 *            the date and time, expressed as the number of milliseconds since 1/1/1970 0:00 GMT (Gregorian).
	 * 
	 * @see #setDate
	 * @see #getTime
	 * @internal
	 ...
	 * 
	 * @param date
	 *            the time and date, expressed as a <code>Date</code> object.
	 * 
	 * @see #setTime
	 * @see #getDate
	 * @internal
	 ...
	 * 
	 * @param jdn
	 *            the desired time, expressed as a "julian day number", which is the number of elapsed days since 1/1/4713 BC (Julian),
	 *            12:00 GMT. Note that julian day numbers start at <em>noon</em>. To get the jdn for the corresponding midnight, subtract
	 *            0.5.
	 * 
	 * @see #getJulianDay
	 * @see #JULIAN_EPOCH_MS
	...
	/**
	 * Get the current time of this <code>CalendarAstronomer</code> object, represented as the number of milliseconds since 1/1/1970 AD 0:00
	 * GMT (Gregorian).
	 * 
	 * @see #setTime
	 * @see #getDate
	...
	/**
	 * Get the current time of this <code>CalendarAstronomer</code> object, represented as a <code>Date</code> object.
	 * 
	 * @see #setDate
	 * @see #getTime
	 * @internal
	...
	/**
	 * Get the current time of this <code>CalendarAstronomer</code> object, expressed as a "julian day number", which is the number of
	 * elapsed days since 1/1/4713 BC (Julian), 12:00 GMT.
	 * 
	 * @see #setJulianDay
	 * @see #JULIAN_EPOCH_MS
	 * @internal
	 ...
	 * 
	 * @param lst
	 *            The Local Sidereal Time, in hours since sidereal midnight on this object's current date.
	 * 
	 ...
	 * 
	 * @param ecliptic
	 *            A point in the sky in ecliptic coordinates.
	...
	/**
	 * The longitude of the sun at the time specified by this object. The longitude is measured in radians along the ecliptic from the
	 * "first point of Aries," the point at which the ecliptic crosses the earth's equatorial plane at the vernal equinox.
	 * <p>
	 * Currently, this method uses an approximation of the two-body Kepler's equation for the earth and the sun. It does not take into
	 * account the perturbations caused by the other planets, the moon, etc.
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the vernal equinox. For use with {@link #getSunTime(SolarLongitude, boolean) getSunTime}. Note: In this case,
	 * "vernal" refers to the northern hemisphere's seasons.
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the summer solstice. For use with {@link #getSunTime(SolarLongitude, boolean) getSunTime}. Note: In this case,
	 * "summer" refers to the northern hemisphere's seasons.
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the autumnal equinox. For use with {@link #getSunTime(SolarLongitude, boolean) getSunTime}. Note: In this case,
	 * "autumn" refers to the northern hemisphere's seasons.
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the winter solstice. For use with {@link #getSunTime(SolarLongitude, boolean) getSunTime}. Note: In this case,
	 * "winter" refers to the northern hemisphere's seasons.
	 * 
	 * @internal
	 */
	...
	public long getSunTime(double desired, boolean next) {
		...
		}, desired, TROPICAL_YEAR, MINUTE_MS, next);
	}
	 ...
	 * 
	 * NOTE: This method only works well if this object is set to a time near local noon. Because of variations between the local official
	 * time zone and the geographic longitude, the computation can flop over into an adjacent day if this object is set to a time near local
	 * midnight.
	 * 
	 * @internal
	 */
	public long getSunRiseSet(boolean rise) {
		...
		}, rise, .533 * DEG_RAD,        // Angular Diameter
	...
	/**
	 * The "age" of the moon at the time specified in this object. This is really the angle between the current ecliptic longitudes of the
	 * sun and the moon, measured in radians.
	 * 
	 * @see #getMoonPhase
	 * @internal
	 */
	...
	/**
	 * Calculate the phase of the moon at the time set in this object. The returned phase is a <code>double</code> in the range
	...
	/**
	 * Constant representing a new moon. For use with {@link #getMoonTime(MoonAge, boolean) getMoonTime}
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the moon's first quarter. For use with {@link #getMoonTime(MoonAge, boolean) getMoonTime}
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing a full moon. For use with {@link #getMoonTime(MoonAge, boolean) getMoonTime}
	 * 
	 * @internal
	 */
	...
	/**
	 * Constant representing the moon's last quarter. For use with {@link #getMoonTime(MoonAge, boolean) getMoonTime}
	 * 
	 * @internal
	 */
	 ...
	 * @param next
	 *            <tt>true</tt> if the next occurrance of the phase is desired, <tt>false</tt> for the previous occurrance.
	 * @internal
	 */
	public long getMoonTime(double desired, boolean next) {
		...
		}, desired, SYNODIC_MONTH, MINUTE_MS, next);
	}
	...
	/**
	 * Normalize an angle so that it's in the range 0 - 2pi. For positive angles this is just (angle % 2pi), but the Java mod operator
	 * doesn't work that way for negative numbers....
	 */
	...
	/**
	 * Find the "true anomaly" (longitude) of an object from its mean anomaly and the eccentricity of its orbit. This uses an iterative
	 * solution to Kepler's equation.
	 * 
	 * @param meanAnomaly
	 *            The object's longitude calculated as if it were in a regular, circular orbit, measured in radians from the point of
	 *            perigee.
	 * 
	 * @param eccentricity
	...
	/**
	 * Return the obliquity of the ecliptic (the angle between the ecliptic and the earth's equator) at the current time. This varies due to
	...
	/**
	 * Represents the position of an object in the sky relative to the ecliptic, the plane of the earth's orbit around the Sun. This is a
	 * spherical coordinate system in which the latitude specifies the position north or south of the plane of the ecliptic. The longitude
	 * specifies the position along the ecliptic plane relative to the "First Point of Aries", which is the Sun's position in the sky at the
	 * Vernal Equinox.
	 * <p>
	 * Note that Ecliptic objects are immutable and cannot be modified once they are constructed. This allows them to be passed and returned
	 * by value without worrying about whether other code will modify them.
	 * 
	...
	public static final class Ecliptic {
		 ...
		 * 
		 * @param lat
		 *            The ecliptic latitude, measured in radians.
		 * @param lon
		...
		/**
		 * The ecliptic latitude, in radians. This specifies an object's position north or south of the plane of the ecliptic, with positive
		...
		/**
		 * The ecliptic longitude, in radians. This specifies an object's position along the ecliptic plane relative to the
		 * "First Point of Aries", which is the Sun's position in the sky at the Vernal Equinox, with positive angles representing east.
		 * <p>
	...
	/**
	 * Represents the position of an object in the sky relative to the plane of the earth's equator. The <i>Right Ascension</i> specifies
	 * the position east or west along the equator, relative to the sun's position at the vernal equinox. The <i>Declination</i> is the
	 * position north or south of the equatorial plane.
	 * <p>
	 * Note that Equatorial objects are immutable and cannot be modified once they are constructed. This allows them to be passed and
	 * returned by value without worrying about whether other code will modify them.
	 * 
	...
	public static final class Equatorial {
		 ...
		 * 
		 * @param asc
		 *            The right ascension, measured in radians.
		 * @param dec
		 *            The declination, measured in radians.
		 * @internal
		 */
		...
		/**
		 * The right ascension, in radians. This is the position east or west along the equator relative to the sun's position at the vernal
		...
		/**
		 * The declination, in radians. This is the position north or south of the equatorial plane, with positive angles representing
		 * north.
		 * 
		 * @internal
		 */
	...
	/**
	 * Represents the position of an object in the sky relative to the local horizon. The <i>Altitude</i> represents the object's elevation
	 * above the horizon, with objects below the horizon having a negative altitude. The <i>Azimuth</i> is the geographic direction of the
	 * object from the observer's position, with 0 representing north. The azimuth increases clockwise from north.
	 * <p>
	 * Note that Horizon objects are immutable and cannot be modified once they are constructed. This allows them to be passed and returned
	 * by value without worrying about whether other code will modify them.
	 * 
	 * @see CalendarAstronomer.Ecliptic
	 * @see CalendarAstronomer.Equatorial
	...
	public static final class Horizon {
		 ...
		 * 
		 * @param alt
		 *            The altitude, measured in radians above the horizon.
		 * @param azim
