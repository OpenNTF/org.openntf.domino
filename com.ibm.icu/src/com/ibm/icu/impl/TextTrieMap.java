...
public class TextTrieMap<V> {
	 ...
	 * 
	 * @param ignoreCase
	 *            true to use simple case insensitive match
	 */
	 ...
	 * 
	 * @param text
	 *            The text to be matched with prefixes.
	 * @return An iterator of the objects associated with the longest prefix matching matching key, or null if no matching entry is found.
	 */
	 ...
	 *            The text to be matched with prefixes.
	 * @param start
	 *            The start index of of the text
	 * @return An iterator of the objects associated with the longest prefix matching matching key, or null if no matching entry is found.
	 */
	...
	public interface ResultHandler<V> {
		 ...
		 * 
		 * @param matchLength
		 *            Matched key's length
		 * @param values
		 *            An iterator of the objects associated with the matched key
