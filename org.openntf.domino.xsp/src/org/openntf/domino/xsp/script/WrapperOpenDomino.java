...
public class WrapperOpenDomino {
	...
	static {
		WRAPPED_CLASSES.add(org.openntf.domino.ext.Document.class);
		WRAPPED_CLASSES.add(org.openntf.domino.ext.Database.class);
		WRAPPED_CLASSES.add(org.openntf.domino.ext.Session.class);
		WRAPPED_CLASSES.add(org.openntf.domino.ext.DateTime.class);
