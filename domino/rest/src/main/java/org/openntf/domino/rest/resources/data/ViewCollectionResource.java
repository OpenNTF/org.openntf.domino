...
@Path(Routes.NAMESPACE_PATH_PARAM + "/" + Routes.DATA + "/" + Routes.VIEWS)
public class ViewCollectionResource extends AbstractCollectionResource {

	public ViewCollectionResource(ODAGraphService service) {
		super(service);
