...
public class AllMembersSupplier extends ParameterSupplier {
	...
	private void addMultiPointMethods(final ParameterSignature sig, final List<PotentialAssignment> list) {
	...
	private void addMultiPointArrayValues(final ParameterSignature sig, final String name, final List<PotentialAssignment> list,
			final Object array) throws Throwable {
		for (int i = 0; i < Array.getLength(array); i++) {
