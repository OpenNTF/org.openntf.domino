...
public interface PipesFluentPipeline<S, E> {
     ...
     * @return the extended Pipeline
     */
    public PipesFluentPipeline<S, E> groupBy(final Map reduceMap, final PipeFunction keyFunction, final PipeFunction valueFunction, final PipeFunction reduceFunction);
     ...
     * @return the extended Pipeline
     */
    public PipesFluentPipeline<S, E> tree(final Tree tree, final PipeFunction... branchFunctions);
     ...
     * @return the extended Pipeline
     */
    public PipesFluentPipeline<S, E> tree(final PipeFunction... branchFunctions);
