...
final class Types {
	...
	private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
		...
		public String toString() {
			...
			builder.append(rawType.getName()).append('<')
					.append(COMMA_JOINER.join(transform(argumentsList, TYPE_NAME))).append('>');
	 ...
	 * In JDK 1.7.0_51-b13, TypeVariableImpl.equals() is changed to no longer be
	 * equal to custom
	 * TypeVariable implementations. As a result, we need to make sure our
	 * TypeVariable implementation
	 * respects symmetry.
	 * Moreover, we don't want to reconstruct a native type variable <A> using
	 * our implementation
	 * unless some of its bounds have changed in resolution. This avoids
	 * creating unequal TypeVariable
