...
/**
 * Provides utility methods for generating fake strings, such as names, phone numbers, addresses. generate random strings with given
 * patterns
 * 
 * @author ren
 */
public class Faker {
	...
	public Faker(final Locale locale) {
		this(locale, null);
	}

	public Faker(final Random random) {
	...
	public int integer(final int lbound, final int ubound) {
		return randomService.nextInt(ubound - lbound) + lbound;
	}
}
