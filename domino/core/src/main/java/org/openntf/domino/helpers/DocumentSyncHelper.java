...
public class DocumentSyncHelper {
	...
	/**
	 * Process a specific document (private method)
	 *
	 * @param targetDb
	 *            Database to get documents to process
	 * @param targetView
	 *            View to get documents to process
	 * @param strategy
	 *            Strategy to apply to documents to process
	 * @param txn
	 *            DatabaseTransaction under which to perform processing
	 * @param source
	 *            Document to use as a source for the sync
	 * @return DatabaseTransaction to use for processing
	 */
