 ...
 * 
 */
public class AgentOpenEvent extends AbstractEMBridgeEvent {
	...
	public AgentOpenEvent(final int eventId) {
		super(eventId);
	}

	public AgentOpenEvent() {
		super(IEMBridgeEvent.EM_AGENTOPEN);
	}

	private void setAgentNoteId(final String agentNoteId) {
