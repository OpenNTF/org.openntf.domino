...
public class NSFDbCopyTemplateACLEvent extends AbstractEMBridgeEvent {
	 ...
	 * @param eventId
	 */
	public NSFDbCopyTemplateACLEvent(final int eventId) {
		super(eventId);
	}
	...
	public NSFDbCopyTemplateACLEvent() {
		super(IEMBridgeEvent.EM_NSFDBCOPYTEMPLATEACL);
	}
