...
public class NSFNoteExtractFileEvent extends AbstractEMBridgeEvent {
	 ...
	 * @param eventId
	 */
	public NSFNoteExtractFileEvent(final int eventId) {
		super(eventId);
	}
	...
	public NSFNoteExtractFileEvent() {
		super(IEMBridgeEvent.EM_NSFNOTEEXTRACTFILE);
	}
