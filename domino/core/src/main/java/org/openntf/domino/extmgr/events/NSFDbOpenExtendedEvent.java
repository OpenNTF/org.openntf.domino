...
public class NSFDbOpenExtendedEvent extends AbstractEMBridgeEvent {
	 ...
	 * @param eventId
	 */
	public NSFDbOpenExtendedEvent(final int eventId) {
		super(eventId);
	}
	...
	public NSFDbOpenExtendedEvent() {
		super(IEMBridgeEvent.EM_NSFDBOPENEXTENDED);
	}
