...
public enum CDSignature {
	...
	TABLECELL_DATAFLAGS(BYTE, 87, CDDATAFLAGS.class), // Note: CDTABLECELLDATAFLAGS is a #define'd alias in the API for CDDATAFLAGS
	...
	BOXSIZE(BYTE, 106, CDBOXSIZE.class),
	POSITIONING(BYTE, 107, CDPOSITIONING.class),
	...
	STYLENAME(BYTE, 166, CDSTYLENAME.class),
	...
	VERTICALALIGN(BYTE, 223, CDVERTICALALIGN.class),
	...
	PLACEHOLDER(WORD, 234, CDPLACEHOLDER.class),
	EMBEDDEDOUTLINE(WORD, 236, CDEMBEDDEDOUTLINE.class),
	EMBEDDEDVIEW(WORD, 237, CDEMBEDDEDVIEW.class),
