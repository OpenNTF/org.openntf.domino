...
public enum DesignMapping {
	...
	public static DesignMapping valueOf(final Document doc) {
		...
		DesignMapping candidate = null;

		for (DesignMapping mapping : DesignMapping.values()) {
			if (mapping == IconNote) {
				// nop - skip iconNote
	...
	public static DesignMapping valueOf(final Class<? extends DesignBase> type) {
		for (DesignMapping mapping : DesignMapping.values()) {
	...
	public static DesignBase fromDocument(final Document doc) {
		if (doc == null)
			return null;
		DesignMapping mapping = valueOf(doc);
		if (mapping == null) {
