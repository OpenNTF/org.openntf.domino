...
public abstract class _AbstractDesignDataResource extends AbstractDesignNoteBase implements org.openntf.domino.design.FileResource {
	...
	protected _AbstractDesignDataResource(final Document document) {
		super(document);
	}

	protected _AbstractDesignDataResource(final Database database) {
		super(database);
	...
	protected _AbstractDesignDataResource(final Database database, final String dxlResource) {
		super(database);
