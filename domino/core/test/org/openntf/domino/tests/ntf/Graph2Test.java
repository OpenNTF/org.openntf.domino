...
public class Graph2Test implements Runnable {
	...
	public interface Movie extends DVertexFrame {
		...
		@Incidence(label = starring, direction = Direction.IN)
		...
		@Adjacency(label = starring, direction = Direction.IN)
	...
	public void run3() {
		...
		try {
			...
			Movie newhopeMovie = framedGraph.getVertex(movieId + MV_SW, Movie.class);
			Movie empireMovie = framedGraph.getVertex(movieId + MV_ESB, Movie.class);
			Movie jediMovie = framedGraph.getVertex(movieId + MV_RoJ, Movie.class);
			Movie phantomMovie = framedGraph.getVertex(movieId + MV_PM, Movie.class);
			Movie clonesMovie = framedGraph.getVertex(movieId + MV_AoC, Movie.class);
			Movie revengeMovie = framedGraph.getVertex(movieId + MV_RoS, Movie.class);

			System.out.println("***************************");
			System.out.println("Don't miss " + newhopeMovie.getTitle() + " starring...");
			...
			System.out.println("***************************");
			System.out.println("Don't miss " + empireMovie.getTitle() + " starring...");
			...
			System.out.println("***************************");
			System.out.println("Don't miss " + jediMovie.getTitle() + " starring...");
	...
	public void run1() {
		...
		try {
			...
			curEdge = luke.addKills(tarkin);
			curEdge.setFilm(newhope.getId().toString());
			curEdge = windu.addKills(jango);
			curEdge.setFilm(clones.getId().toString());
			curEdge = palpatine.addKills(windu);
			curEdge.setFilm(revenge.getId().toString());
			curEdge = wedge.addKills(anakin);
			curEdge.setFilm(jedi.getId().toString());
			curEdge = lando.addKills(anakin);
			curEdge.setFilm(jedi.getId().toString());
			curEdge = anakin.addKills(palpatine);
			curEdge.setFilm(jedi.getId().toString());
			curEdge = maul.addKills(quigon);
			curEdge.setFilm(phantom.getId().toString());
			curEdge = obiwan.addKills(maul);
			curEdge.setFilm(phantom.getId().toString());
			curEdge = han.addKills(greedo);
			curEdge.setFilm(newhope.getId().toString());
			curEdge = han.addKills(boba);
			curEdge.setFilm(jedi.getId().toString());
			curEdge = anakin.addKills(tyranus);
			curEdge.setFilm(revenge.getId().toString());
