...
public class TokenMgrError extends Error {
	 ...
	 * indicates if EOF caused the lexical error curLexState : lexical state in which this error occurred errorLine : line number when the
	 ...
	 * INVALID_LEXICAL_STATE are not of end-users concern, so you can return something like :
	 *
	...
	/** Full Constructor. */
	public TokenMgrError(final boolean EOFSeen, final int lexState, final int errorLine, final int errorColumn, final String errorAfter,
			final char curChar, final int reason) {
		this(LexicalError(EOFSeen, lexState, errorLine, errorColumn, errorAfter, curChar), reason);
	}
}
/* JavaCC - OriginalChecksum=b350e3be43405efed42b4494b9901ebd (do not edit this line) */
