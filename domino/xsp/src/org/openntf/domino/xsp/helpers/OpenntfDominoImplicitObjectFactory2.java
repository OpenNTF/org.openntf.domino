...
public class OpenntfDominoImplicitObjectFactory2 implements ImplicitObjectFactory {
	...
	//		
	//		Map<String, Object> requestMap = TypedUtil.getRequestMap(ctx.getExternalContext());
	//		if (isAppGodMode(ctx)) {
	//			
	//			requestMap.put("session", Factory.getSession(session));
	//		}
	//		
	//
	...
	//		session = Factory.getSession_unchecked(SessionType.CURRENT);
	...
	//					Factory.setSession(rawSession, SessionType.CURRENT);
	...
	public String[][] getImplicitObjectList() {
		return null; // this.implicitObjectList;
	}
