...
public class JsonGenerator {
	 ...
	 *            the object factory
	 * @param value
	 *            the convert to serialize
	 * @return the resulting JSON string
	 * @throws IOException
	 * @throws JsonException
	 * @ibm-api
	 */
	public static String toJson(final JsonFactory factory, final Object value) throws IOException, JsonException {
	 ...
	 *            the convert to serialize
	 * @param compact
	 *            indicates if the string should be in a compact format
	 * @return the resulting JSON string
	 * @throws IOException
	 * @throws JsonException
	 * @ibm-api
	 */
	public static String toJson(final JsonFactory factory, final Object value, final boolean compact) throws IOException, JsonException {
	 ...
	 *            the object factory
	 * @param b
	 *            the StringBuilder to append the text to
	 * @param value
	 *            the convert to serialize
	 * @param compact
	 *            indicates if the string should be in a compact format
	 ...
	 * @ibm-api
	 */
	public static StringBuilder toJson(final JsonFactory factory, final StringBuilder b, final Object value, final boolean compact)
	 ...
	 * @ibm-api
	 */
	public static void toJson(final JsonFactory factory, final Writer writer, final Object value, final boolean compact)
			throws IOException, JsonException {
	...
	public abstract static class Generator {
		...
		protected Generator(final JsonFactory factory, final boolean compact) {
		...
		public void toJson(final Object value) throws IOException, JsonException {
			outLiteral(value);
		}

		public void outLiteral(final Object value) throws IOException, JsonException {
		 ...
		 *            The value to write.
		 * @param named
		 *            <code>true</code> if the property is named.
		 * @throws IOException
		 * @throws JsonException
		 */
		protected void outLiteral(final Object value, final boolean named) throws IOException, JsonException {
			if (factory.isNull(value)) {
				outNull(); // $NON-NLS-1$
			} else if (factory.isString(value)) {
				outStringLiteral(factory.getString(value));
			} else if (factory.isDate(value)) {
				outDateLiteral_(factory.getDate(value));
		...
		public void outObject(final Object object) throws IOException, JsonException {
		 ...
		 *            The object to write.
		 * @param named
		 *            <code>true</code> if the object is named.
		 * @throws IOException
		 * @throws JsonException
		 */
		protected void outObject(final Object object, final boolean named) throws IOException, JsonException {
			if (named) {
		...
		protected void startObject(final Object object) throws IOException, JsonException {
			out('{');
		}

		protected void endObject(final Object object) throws IOException, JsonException {
			out('}');
		}

		public void outPropertyName(final String s) throws IOException {
			outStringLiteral(s);
		}

		public void outStringLiteral(final String s) throws IOException {
			out('\"');
			int len = s.length();
			for (int i = 0; i < len; i++) {
				char c = s.charAt(i);
		...
		public void outCharInString(final char c) throws IOException {
			switch (c) {
			case '"': {
				out("\\\""); //$NON-NLS-1$
			}
		...
		public void outNumberLiteral(final double d) throws IOException {
			long l = (long) d;
			if (((double) l) == d) {
		...
		public void outDateLiteral_(final Date value) throws IOException {
			String s = dateToString(value);
			outStringLiteral(s);
		}

		public void outIntLiteral(final int d) throws IOException {
			String s = Integer.toString(d);
			out(s);
		}

		public void outLongLiteral(final long d) throws IOException {
			String s = Long.toString(d);
			out(s);
		}

		public void outBooleanLiteral(final boolean b) throws IOException {
			out(b ? "true" : "false"); //$NON-NLS-1$ //$NON-NLS-2$
		}

		public void outArrayLiteral(final Object array) throws IOException, JsonException {
		 ...
		 * @throws JsonException
		 */
		protected void outArrayLiteral(final Object array, final boolean named) throws IOException, JsonException {
		...
		public void outReference(final JsonReference ref) throws IOException, JsonException {
			String s = ref.getRef();
	...
	public static class StringGenerator extends Generator {
		...
		public StringGenerator(final JsonFactory factory, final boolean compact) {
		...
		@Override
		public void out(final char c) throws IOException {
			b.append(c);
		}

		@Override
		public void out(final String s) throws IOException {
			b.append(s);
		}
	}
	...
	public static class StringBuilderGenerator extends Generator {
		...
		public StringBuilderGenerator(final JsonFactory factory, final StringBuilder b, final boolean compact) {
			super(factory, compact);
			this.b = b;
		}
	...
	public static class WriterGenerator extends Generator {
		...
		public WriterGenerator(final JsonFactory factory, final Writer writer, final boolean compact) {
			super(factory, compact);
			this.writer = writer;
		}
	...
	public static String dateToString(final Date value) throws IOException {
		return ISO8601.format(value);
	}

	public static Date stringToDate(final String value) throws IOException, ParseException {
