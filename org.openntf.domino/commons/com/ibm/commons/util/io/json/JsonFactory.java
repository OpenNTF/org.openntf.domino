 ...
 * JSON factory.
 * <p>
 * This factory links the JSON classes with the actual physical objects. It is used by both the parser and the generator to access object
 * properties and create new instance. Any kind of object hierarchy can be handled through implementations of the factory.
 * </p>
 * 
 * @ibm-api
 */
public interface JsonFactory {
	...
	/** @ibm-api */
	public boolean isDate(Object value) throws JsonException;

	/** @ibm-api */
	public Date getDate(Object value) throws JsonException;
