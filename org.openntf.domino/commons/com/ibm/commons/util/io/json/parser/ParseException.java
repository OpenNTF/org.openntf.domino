...
public class ParseException extends Exception {
  ...
  private static String initialise(Token currentToken,
    ...
    if (expectedTokenSequences.length == 1) {
      retval += "Was expecting:" + eol + "    "; // $NON-NLS-1$
    } else {
      retval += "Was expecting one of:" + eol + "    "; // $NON-NLS-1$
    }
...
/* JavaCC - OriginalChecksum=a41980c8132463ba229fb6894ffc27c5 (do not edit this line) */