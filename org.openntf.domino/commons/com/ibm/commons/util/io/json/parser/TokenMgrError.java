...
public class TokenMgrError extends Error
{
  ...
  protected static String LexicalError(boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter, char curChar) {
    return("Lexical error at line " + // $NON-NLS-1$
          ...
          (EOFSeen ? "<EOF> " : ("\"" + addEscapes(String.valueOf(curChar)) + "\"") + " (" + (int)curChar + "), ") + // $NON-NLS-1$
          "after : \"" + addEscapes(errorAfter) + "\""); // $NON-NLS-1$
  }
...
/* JavaCC - OriginalChecksum=658a24b1bd60fa816c02e9978be75f63 (do not edit this line) */