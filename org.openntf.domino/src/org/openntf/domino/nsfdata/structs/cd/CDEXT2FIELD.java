...
public class CDEXT2FIELD extends CDRecord {
	...
	static {
		...
		addFixedUpgrade("DecimalSymLength", Integer.class);
		addFixedUpgrade("MilliSepSymLength", Integer.class);
		addFixedUpgrade("NegativeSymLength", Integer.class);
		addFixedUpgrade("MilliGroupSize", Short.class);
		addFixedUpgrade("VerticalSpacing", Short.class);
		addFixedUpgrade("HorizontalSpacing", Short.class);
		...
		addFixedUpgrade("CurrencySymLength", Integer.class);
		addFixed("ISOCountry", Integer.class);
		addFixedUpgrade("ThumbnailImageWidth", Short.class);
		addFixedUpgrade("ThumbnailImageHeight", Short.class);
		addFixedUpgrade("wThumbnailImageFileNameLength", Short.class);
		addFixedUpgrade("wIMOnlineNameFormulaLen", Short.class);
		...
		addFixedUpgrade("DTDsep1Len", Byte.class);
		addFixedUpgrade("DTDsep2Len", Byte.class);
		addFixedUpgrade("DTDsep3Len", Byte.class);
		addFixedUpgrade("DTTsepLen", Byte.class);
		...
		addFixedUpgrade("wCharacters", Short.class);
		addFixedUpgrade("wInputEnabledLen", Short.class);
		addFixedUpgrade("wIMGroupFormulaLen", Short.class);
