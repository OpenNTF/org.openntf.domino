 ...
 * 
 * Map Keys are Integers: MappedSerializables
 * 
 * @author Devin Olson dolson@czarnowski.com
 * 
 * @updated 01/2014
 */
public class IntegerMappedSerializables extends MappedSerializables {
	 ...
	 */
	public IntegerMappedSerializables() {
		super();
	}
	 ...
	 */
	public IntegerMappedSerializables(final HashMap<Serializable, Serializable> content) {
		super(content);
		this.clean();
	}
	 ...
	 */
	@Override
	public IntegerMappedSerializables clone() {
		return (this.isEmpty()) ? new IntegerMappedSerializables() : new IntegerMappedSerializables(this.getContent());
	}
	 ...
	 */
	public Serializable get(final Integer key) {
	...
	public Serializable put(final Serializable key, final Serializable value) {
		return (key instanceof Integer) ? super.put((Integer) key, value) : null;
	}
	 ...
	 * @return Previous value for the key, if it existed in the internal Map.
	 */
	public Serializable put(final Integer key, final String value) {
	 ...
	 * @return Previous value for the key, if it existed in the internal Map.
	 */
	public Serializable remove(final Integer key) {
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public Boolean getBoolean(final Integer key) {
	 ...
	 */
	public Boolean putBoolean(final Integer key, final Boolean value) {
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public Integer getInteger(final Integer key) {
	 ...
	 */
	public Integer putInteger(final Integer key, final Integer value) {
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public Date getDate(final Integer key) {
	 ...
	 */
	public Date putDate(final Integer key, final Date value) {
	 ...
	 * @return previous value associated with the key, IF AND ONLY IF the previous value was a Date object. Null otherwise.
	 */
	public Date setTime(final Integer key, final Date time) {
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public String getTimestamp(final Integer key, final String format) {
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public String getTimestamp(final Integer key) {
	 ...
	 */
	public String putString(final Integer key, final String value) {
	 ...
	 */
	public boolean containsName(final Integer key) {
		return (this.checkKey(key)) ? super.getBoolean(key) : null;
	}
	 ...
	 * @return Value associated with the key. Null if not found or exception occurs.
	 */
	public Name getName(final Integer key) {
	 ...
	 */
	public Name putName(final Integer key, final Name value) {
	 ...
	 * ******************************************************************
	 */
	private boolean checkKey(final Integer key) {
		return (null == key) ? false : true;
	}
