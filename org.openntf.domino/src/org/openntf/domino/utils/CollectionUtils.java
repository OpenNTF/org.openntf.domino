...
public class CollectionUtils  {
	...
	public static List<String> getListStrings(final Object object) {
		String classname = null;
			if (null != object) {
				...
				if (object instanceof Vector) { return CollectionUtils.getListStrings((Vector) object); }
				if (object instanceof AbstractCollection) { return CollectionUtils.getListStrings((AbstractCollection) object); }
				if (object instanceof AbstractMap) { return CollectionUtils.getListStrings((AbstractMap) object); }
				if (object instanceof String) { return CollectionUtils.getListStrings((String) object); }
				if (object instanceof String[]) { return CollectionUtils.getListStrings((String[]) object); }
				if (classname.equalsIgnoreCase("java.lang.String[]") || classname.equalsIgnoreCase("[Ljava.lang.String;")) { return CollectionUtils
				        .getListStrings((String[]) object); }
				if (classname.equalsIgnoreCase("java.lang.String")) { return CollectionUtils.getListStrings((String) object); }
	...
	public static int compareStringArrays(final String[] stringarray0, final String[] stringarray1, final boolean descending) {
		try {
			...
			CzarCore.logException(CollectionUtils.CLASSNAME, e, "stringarray0:" + stringarray0, "stringarray1:" + stringarray1,
			        "descending:" + descending);
			throw new RuntimeException("EXCEPTION in CollectionUtils.compareStringArrays()");
		}
	}
	...
	public static int compareTreeSetStrings(final TreeSet<String> treeset0, final TreeSet<String> treeset1, final boolean descending) {
		try {
			...
			CzarCore.logException(CollectionUtils.CLASSNAME, e, "treeset0:" + treeset0, "treeset1:" + treeset1, "descending:" + descending);
			throw new RuntimeException("EXCEPTION in CollectionUtils.compareTreeSetStrings()");
		}
	}
	...
	public static TreeSet<String> getTreeSetStringsBeginsWith(final Object source, final String prefix) {
		try {
			...
			CzarCore.logException(CollectionUtils.CLASSNAME, "Prefix: " + prefix);
		}
