...
public enum DACL {
	...
	public static enum TYPE {
		 ...
		 * 
		 * @param document
		 *            Document upon which to set the DACL.TYPE item.
		 * 
		 * @param members
		 *            Names or roles to be set as the DACL.TYPE value.
		 * 
		 * @param override
		 ...
		 * 
		 * @param values
		 *            Names or roles (String or object convertable to a TreeSet of Strings) to be set as the DACL.TYPE value.
		 * 
		 * @return Flag indicating the success / failure of the operation.
		 */
		...
		/**
		 * Adds a members to the DACL.TYPE for the document.
		 * 
		 * Existing DACL.TYPE members are not removed. Adds the Default role {@link DACL.TYPE#getRole()}. Does NOT save the document.
		 * 
		 * @param document
		 *            Document upon which to update the .
		 * 
		 * @param members
		 *            Names or roles to be added to the DACL.TYPE value.
		 * 
		 * @return Flag indicating the success / failure of the operation.
		 */
		...
		/**
		 * Adds a Role to the appropriate DACL.TYPE item on a document.
		 * 
		 * @param document
		...
		/**
		 * Removes the DACL.TYPE item from the source document.
		 * 
		 * Conditionally removes ALL DACL.TYPE items or ONLY the item defined by {@link DACL.TYPE#getItemname()}.
		 * 
		 * Does NOT save the document.
		 * 
		 * @param document
		 *            Document from which to remove the DACL.TYPE item(s).
		 * 
		 * @param removeAll
		 *            Flag indicating if ALL DACL.TYPE items found on the document should be removed.
		 * 
		 ...
		 * Removes the DACL.TYPE item from the source document.
		 * 
		 * Removed ONLY the item defined by {@link DACL.TYPE#getItemname()}.
		 * 
		 * Does NOT save the document.
		 * 
		 * @param document
		...
		/**
		 * Removes an explicit to the DACL.TYPE for the document.
		 * 
		 * Does NOT save the document.
		 * 
		 * @param document
		 ...
		 * 
		 * @param member
		 *            Names or roles to be removed from the DACL.TYPE value.
		 * 
		 * @return Flag indicating the success / failure of the operation.
		 */
		...
		/**
		 * Removes members to the DACL.TYPE for the document.
		 * 
		 * Does NOT save the document.
		 * 
		 * @param document
	 ...
	 * @return DACL Member values. Null if not present or empty.
	 */
	public static TreeSet<String> values(final Document document, final DACL.TYPE daclType, final boolean checkAllItems) {
	 ...
	 * @return Flag indicating the success / failure of the operation.
	 */
	public static boolean set(final Document document, final TreeSet<String> values, final String itemname, final DACL.TYPE daclType,
	 ...
	 * 
	 * @param daclType
	 *            DACL.TYPE (AUTHOR or READER) for which to search. If null then removes both AUTHOR and READER types.
	 * 
	 * @param removeAll
	 *            Flag indicating if ALL DACL.TYPE items found on the document should be removed.
	 * 
	 * @return Flag indicating if the item was successfully removed.
	 */
	public static boolean remove(final Document document, final DACL.TYPE daclType, final boolean removeAll) {
		try {
			if (null == document) {
				throw new IllegalArgumentException("Document is null");
			}
			...
			if (null == daclType) {
				boolean resultAuthors = DACL.remove(document, DACL.TYPE.AUTHORS, removeAll);
				boolean resultReaders = DACL.remove(document, DACL.TYPE.READERS, removeAll);
	...
	public static TreeSet<String> getAuthors(final Document document) {
		return DACL.TYPE.AUTHORS.values(document);
	}
	...
	public static boolean setAuthors(final Document document, final Object values) {
		return TYPE.AUTHORS.set(document, values);
	}
	...
	public static boolean addAuthors(final Document document, final Object values) {
		return TYPE.AUTHORS.add(document, values);
	}
	...
	public static boolean removeAuthors(final Document document) {
		return TYPE.AUTHORS.remove(document);
	}
	...
	public static boolean removeAuthor(final Document document, final String value) {
		return TYPE.AUTHORS.remove(document, value);
	}
	...
	public static TreeSet<String> getReaders(final Document document) {
		return DACL.TYPE.READERS.values(document);
	}
	...
	public static boolean setReaders(final Document document, final Object values) {
		return TYPE.READERS.set(document, values);
	}
	...
	public static boolean addReaders(final Document document, final Object values) {
		return TYPE.READERS.add(document, values);
	}
	...
	public static boolean removeReaders(final Document document) {
		return TYPE.READERS.remove(document);
	}
	...
	public static boolean removeReader(final Document document, final String value) {
		return TYPE.READERS.remove(document, value);
	}
