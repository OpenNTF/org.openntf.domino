...
class BasicDurationFormatterFactory implements DurationFormatterFactory {
	 ...
	 * 
	 * @param fallback
	 *            the fallback formatter to use, or null
	 * @return this BasicDurationFormatterFactory
	 */
	 ...
	 * 
	 * @param fallbackLimit
	 *            the fallback limit to use, or 0 if none is desired.
	 * @return this BasicDurationFormatterFactory
	 */
	...
	/**
	 * Clear the cached formatter. Subclasses must call this if their state has changed. This is automatically invoked by setBuilder,
