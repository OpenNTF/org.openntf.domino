...
/**
 * A replacer that calls a transliterator to generate its output text. The input text to the transliterator is the output of another
 * UnicodeReplacer object. That is, this replacer wraps another replacer with a transliterator.
 * 
 * @author Alan Liu
 */
class FunctionReplacer implements UnicodeReplacer {
	...
	/**
	 * Construct a replacer that takes the output of the given replacer, passes it through the given transliterator, and emits the result as
	 * output.
	 */
