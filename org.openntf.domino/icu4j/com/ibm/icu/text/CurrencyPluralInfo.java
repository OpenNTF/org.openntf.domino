 ...
 * DecimalFormat creates for itself an instance of CurrencyPluralInfo from its locale data. If you need to change any of these symbols, you
 * can get the CurrencyPluralInfo object from your DecimalFormat and modify it.
 * 
 * Following are the information needed for currency plural format and parse: locale information, plural rule of the locale, currency plural
 * pattern of the locale.
 * 
 * @stable ICU 4.2
 */
...
public class CurrencyPluralInfo implements Cloneable, Serializable {
	...
	public boolean equals(Object a) {
		if (a instanceof CurrencyPluralInfo) {
			...
			return pluralRules.equals(other.pluralRules) && pluralCountToCurrencyUnitPattern.equals(other.pluralCountToCurrencyUnitPattern);
		}
		return false;
	}

	/**
	 * Mock implementation of hashCode(). This implementation always returns a constant value. When Java assertion is enabled, this method
