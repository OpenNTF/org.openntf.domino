...
/**
 * <code>StringCharacterIterator</code> implements the <code>CharacterIterater</code> protocol for a <code>String</code>. The
 * <code>StringCharacterIterator</code> class iterates over the entire <code>String</code>.
 * 
...
public final class StringCharacterIterator implements CharacterIterator {
	...
	/**
	 * Reset this iterator to point to a new string. This package-visible method is used by other java.text classes that want to avoid
	 * allocating new StringCharacterIterator objects every time their setText method is called.
	 * 
	 * @param text
	 *            The String to be iterated over
	 * @deprecated ICU 2.4. Use java.text.StringCharacterIterator instead.
	 ...
	 * @return true if the given obj is the same as this StringCharacterIterator object; false otherwise.
	 * @deprecated ICU 2.4. Use java.text.StringCharacterIterator instead.
	 */
	@Deprecated
	@Override
