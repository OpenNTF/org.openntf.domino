...
public final class CharsTrieBuilder extends StringTrieBuilder {
	...
	/**
	 * Adds a (string, value) pair. The string must be unique. The string contents will be copied; the builder does not keep a reference to
	 * the input CharSequence.
	 * 
	 * @param s
	 *            The input string.
	 * @param value
	 *            The value associated with this char sequence.
	 * @return this
	 * @stable ICU 4.8
	 */
	 ...
	 * 
	 * <p>
	 * Multiple calls to build() or buildCharSequence() return tries or sequences which share the builder's char array, without rebuilding.
	 ...
	 * @stable ICU 4.8
	 */
	public CharsTrie build(final StringTrieBuilder.Option buildOption) {
	 ...
	 * @stable ICU 4.8
	 */
	public CharSequence buildCharSequence(final StringTrieBuilder.Option buildOption) {
		buildChars(buildOption);
		return CharBuffer.wrap(chars, chars.length - charsLength, charsLength);
	}

	private void buildChars(final StringTrieBuilder.Option buildOption) {
