 ...
 * <p>
 * CopticCalendar usually should be instantiated using {@link com.ibm.icu.util.Calendar#getInstance(ULocale)} passing in a
 * <code>ULocale</code> with the tag <code>"@calendar=coptic"</code>.
 * </p>
 * 
...
public final class CopticCalendar extends CECalendar {
	...
	/**
	 * Constant for &#x03a0;&#x03b1;&#x03c1;&#x03b5;&#x03bc;&#x03e9;&#x03b1;&#x03c4;/&#x062a;&#xfe8e;&#xfeec;&#xfee3;&#xfeae;&#xfe91;, the
	 * 7th month of the Coptic year.
	 * 
	 * @stable ICU 3.4
	 */
	...
	/**
	 * Constant for &#x03a6;&#x03b1;&#x03c1;&#x03bc;&#x03bf;&#x03b8;&#x03b9;/&#x0647;&#x062f;&#xfeee;&#xfee3;&#xfeae;&#xfe91;, the 8th month
	 * of the Coptic year.
	 * 
	 * @stable ICU 3.4
	 */
	...
	/**
	 * Constructs a default <code>CopticCalendar</code> using the current time in the default time zone with the default locale.
	 * 
	 * @stable ICU 3.4
	 */
	...
	/**
	 * Constructs a <code>CopticCalendar</code> based on the current time in the given time zone with the default locale.
	 * 
	 * @param zone
	...
	/**
	 * Constructs a <code>CopticCalendar</code> based on the current time in the given time zone with the given locale.
	 * 
	 * @param zone
	 *            The time zone for the new calendar.
	 * @param aLocale
	...
	/**
	 * Constructs a <code>CopticCalendar</code> with the given date set in the default time zone with the default locale.
	 * 
	 * @param year
	 *            The value used to set the calendar's {@link #YEAR YEAR} time field.
	 * @param month
	 *            The value used to set the calendar's {@link #MONTH MONTH} time field. The value is 0-based. e.g., 0 for Tout.
	 * @param date
	...
	/**
	 * Constructs a <code>CopticCalendar</code> with the given date and time set for the default time zone with the default locale.
	 * 
	 * @param year
	 *            The value used to set the calendar's {@link #YEAR YEAR} time field.
	 * @param month
