...
public class TimeUnit extends MeasureUnit {
	 ...
	 * @stable ICU 4.0
	 */
	public static TimeUnit SECOND = new TimeUnit("second"), MINUTE = new TimeUnit("minute"), HOUR = new TimeUnit("hour"),
			DAY = new TimeUnit("day"), WEEK = new TimeUnit("week"), MONTH = new TimeUnit("month"), YEAR = new TimeUnit("year");
