...
/**
 * <b>Note:</b> The Holiday framework is a technology preview. Despite its age, is still draft API, and clients should treat it as such.
 * 
...
public class SimpleDateRule implements DateRule {
	 ...
	 * @param after
	 *            If true, this rule selects the first dayOfWeek on or after dayOfMonth. If false, the rule selects the first dayOfWeek on
	 ...
	 * 
	 * @return The date on which this event occurs, or null if it does not occur on or after the start date.
	 * 
	 * @see #firstBetween
	 * @draft ICU 2.8
	 * @provisional This API might change or be removed in a future release.
	...
	/**
	 * Return the first occurrance of the event represented by this rule that is on or after the given start date and before the given end
	 * date.
	 * 
	 * @param start
	 *            Only occurrances on or after this date are returned.
	 ...
	 * 
	 * @return The date on which this event occurs, or null if it does not occur between the start and end dates.
	 * 
	 * @see #firstAfter
	 * @draft ICU 2.8
	 * @provisional This API might change or be removed in a future release.
	...
	/**
	 * Checks whether this event occurs on the given date. This does <em>not</em> take time of day into account; instead it checks whether
	 * this event and the given date are on the same day. This is useful for applications such as determining whether a given day is a
	 * holiday.
	 * 
	 * @param date
	 *            The date to check.
