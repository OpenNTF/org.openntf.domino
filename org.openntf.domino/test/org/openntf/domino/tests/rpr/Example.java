...
public class Example {
	public static void usage() {
		System.out.println("Usage: java " + Example.class.getName() + " [none/simple/files/dictionary [trigger mask]]");
	...
	public static void main(final String[] args) throws IOException {
		...
		if (args.length > 0) {
			if (args[0].equals("none")) {
				...
				completors.add(new SimpleCompletor(new GZIPInputStream(Example.class.getResourceAsStream("english.gz"))));
