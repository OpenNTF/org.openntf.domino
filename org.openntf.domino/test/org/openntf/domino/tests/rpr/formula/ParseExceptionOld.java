 ...
 */
public class ParseExceptionOld extends Exception {
	 ...
	 */
	public ParseExceptionOld(final Token currentTokenVal, final int[][] expectedTokenSequencesVal, final String[] tokenImageVal) {
	...
	public ParseExceptionOld() {
		super();
	}

	/** Constructor with message. */
	public ParseExceptionOld(final String message) {
		super(message);
	}

	public ParseExceptionOld(final AtFormulaParser parser, final String message) {
		super(initialise(parser, message, AtFormulaParserConstants.tokenImage));
	...
	/**
	 * Each entry in this array is an array of integers. Each array of integers represents a sequence of tokens (by their ordinal values)
	 * that is expected at this point of the parse.
	 */
	public int[][] expectedTokenSequences;

	/**
	 * This is a reference to the "tokenImage" array of the generated parser within which the parse error occurred. This array is defined in
	 * the generated ...Constants interface.
	 */
	...
	private static String initialise(final AtFormulaParser parser, final String message, final String[] tokenImage) {
		String eol = System.getProperty("line.separator", "\n");
		StringBuffer expected = new StringBuffer();
		int maxSize = 0;
