 ...
 */
public class ParameterCountMismatch extends RuntimeException {
	...
	public ParameterCountMismatch() {
		super();
	}

	/** Constructor with message. */
	public ParameterCountMismatch(final String message) {
		super(message);
	}

	public ParameterCountMismatch(final SimpleNode node, final String message) {
