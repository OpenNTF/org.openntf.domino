...
final class BreakIteratorFactory extends BreakIterator.BreakIteratorServiceShim {
	...
	private static class BFService extends ICULocaleService {
		BFService() {
			...
			class RBBreakIteratorFactory extends ICUResourceBundleFactory {
				@Override
				protected Object handleCreate(final ULocale loc, final int kind, final ICUService srvc) {
	...
	/**
	 * KIND_NAMES are the resource key to be used to fetch the name of the pre-compiled break rules. The resource bundle name is
	 * "boundaries". The value for each key will be the rules to be used for the specified locale - "word" -> "word_th" for Thai, for
	 * example.
	 */
