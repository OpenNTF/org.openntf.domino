...
/**
 * <p>
 * Interface for enabling iteration over sets of &lt;int, Object>, where int is the sorted integer index in ascending order, and Object its
 * associated value.
 * </p>
 * <p>
 ...
 * Implementations of ValueIterator should specify their own maximum subrange within the above range that is meaningful to its applications.
 * </p>
 * <p>
 * Most implementations will be created by factory methods, such as the character name iterator in UCharacter.getNameIterator. See example
 * below.
 * </p>
 * Example of use:<br>
 * 
 ...
 * 	System.out.println(&quot;Codepoint \\u&quot; + Integer.toHexString(result.integer) + &quot; has the character name &quot; + (String) result.value);
 * }
 * </pre>
 * 
 * @author synwee
...
public interface ValueIterator {
	 ...
	 * </p>
	 * <p>
	 * If setRange(start, end) is not performed before next(element) is called, the iteration will start from the integer index
