...
/**
 * <code>InitialTimeZoneRule</code> represents a time zone rule representing a time zone effective from the beginning and has no actual
 * start times.
 * 
 * @stable ICU 3.8
 */
public class InitialTimeZoneRule extends TimeZoneRule {
	...
	/**
	 * Constructs a <code>InitialTimeZoneRule</code> with the name, the GMT offset of its standard time and the amount of daylight saving
	 * offset adjustment.
	 * 
	 * @param name
	 *            The time zone name.
	 * @param rawOffset
	 *            The UTC offset of its standard time in milliseconds.
	 * @param dstSavings
