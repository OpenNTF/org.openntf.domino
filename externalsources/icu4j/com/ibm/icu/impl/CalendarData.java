...
public class CalendarData {
	 ...
	 * 
	 * @param loc
	 *            locale to use. The 'calendar' keyword will be ignored.
	 * @param type
	 *            calendar type. NULL indicates the gregorian calendar. No default lookup is done.
	 */
	...
	/**
	 * Load data for calendar. Note, this object owns the resources, do NOT call ures_close()! There is an implicit key of 'format' data is
	 * located in: "calendar/key/format/subKey" for example, calendar/dayNames/format/abbreviated
	 * 
	 * @param key
	 *            Resource key to data
	 * @param subKey
	...
	/**
	 * Load data for calendar. Note, this object owns the resources, do NOT call ures_close()! data is located in:
	 * "calendar/key/contextKey/subKey" for example, calendar/dayNames/stand-alone/narrow
	 * 
	 * @param key
	 *            Resource key to data
	 * @param contextKey
	...
	/**
	 * Load data for calendar. Note, this object owns the resources... data is located in: "calendar/key/set/contextKey/subKey" for example,
	 * calendar/cyclicNameSets/years/format/abbreviated
	 * 
	 * @param key
	 *            Resource key to data
	 * @param set
